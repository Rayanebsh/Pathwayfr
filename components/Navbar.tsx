          ...
          {isLoggedIn ? (
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <svg className="ml-1 w-4 h-4 text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg>
              </button>
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-blue-100 rounded shadow-lg z-50 animate-fade-in">
                  <Link href="/profile" className="block px-4 py-2 text-slate-700 hover:bg-blue-50 transition-colors">Voir profil</Link>
                  <button
